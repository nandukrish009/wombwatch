    ...
    <div className='my-20 container'>
       ...
       <div className='my-12'>
        ...
        <div className='w-1/3 max-md:w-full rounded-xl overflow-hidden flex justify-center object-cover'>
          <Image src='/ultra_sound.jpg' alt='Delayed Diagnosis' width={600} height={600} />
        </div>
        <div className='w-1/2 max-md:w-full bg-[#dcf3f9] rounded-xl py-16 px-12'>
        ...
        <div className='w-1/2 max-md:w-full bg-[#feefec] rounded-xl py-16 px-12'>
        ...
        <div className='w-1/3 max-md:w-full rounded-xl overflow-hidden flex justify-center object-cover'>
          <Image src='/overlooked.jpg' alt='Delayed Diagnosis' width={600} height={600} />
        </div>
        </div>

        <div className='flex gap-6 justify-center my-6 max-md:flex-col'>
        <div className='w-1/3 max-md:w-full rounded-xl overflow-hidden flex justify-center object-cover'>
          <Image src='/limited_treatment.jpg' alt='Delayed Diagnosis' width={600} height={600} />
        </div>
        <div className='w-1/2 max-md:w-full bg-[#cbffde] rounded-xl py-16 px-12'>
